...
```{r plot4, echo=FALSE, warning = FALSE, message=FALSE, fig.width = 6, fig.height = 3.25}
## plots from COVID.R
p4
```
...
## table 2
 dataWide %>%
   ...
   rename(`Hospitalized` = Currently.hospitalized, `Active` = Currently.sick, `Tests` = Daily.tests, `People tested` = Daily.tests.people) %>%
   ...
   row_spec(7, color = "white", background = "#FF33CC")
```
