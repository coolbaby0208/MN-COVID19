...
## table 2
 dataWide %>%
   ...
   rename(`Hospitalized` = Currently.hospitalized, `Active` = Currently.sick, `Tests` = Daily.tests, `New people tested` = Daily.tests.people) %>%
   select(Date, Hospitalized, ICU, Active, Tests, `New people tested`) %>% 
