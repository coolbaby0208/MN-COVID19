...
```{r plot3, echo=FALSE, warning = FALSE, message=FALSE,fig.width = 6, fig.height = 5}
## plots from COVID.R
p3
```

```{r plot5, echo=FALSE, warning = FALSE, message=FALSE, fig.width = 6, fig.height = 4.5}
## plots from COVID.R
p5
```


```{r plot4, echo=FALSE, warning = FALSE, message=FALSE, fig.width = 6, fig.height = 3.5}
## plots from COVID.R
p4
```
