...
* Hospital admission/Vaccince  
  ...
  + Total accumulated vaccinated (people): **`r (dataWidePlain$Total.vaccine.people) %>% formatC(format="d", big.mark=",")`** (`r (ifelse(dataWidePlain$New.vaccine.people <0, sprintf("down"), sprintf("up")))` `r (abs((dataWidePlain$New.vaccine.people))) %>% formatC(format="d", big.mark=",")`) 
...
```{r plot3, echo=FALSE, warning = FALSE, message=FALSE,fig.width = 6, fig.height = 4.8}
## plots from COVID.R
p3
```

```{r plot5, echo=FALSE, warning = FALSE, message=FALSE, fig.width = 6, fig.height = 4.6}
## plots from COVID.R
p5
```


```{r plot4, echo=FALSE, warning = FALSE, message=FALSE, fig.width = 6, fig.height = 3.4}
## plots from COVID.R
p4
```
