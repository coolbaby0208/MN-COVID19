...
* Hospital admission/Vaccine  
  ...
  + Total people with completed vaccination: **`r (dataWidePlain$Total.people.vaccine.completed) %>% formatC(format="d", big.mark=",")`** (`r (ifelse(is.null(dataWidePlain$New.people.vaccine.completed), sprintf("NA"), sprintf("up")))` `r ((dataWidePlain$New.people.vaccine.completed)) %>% formatC(format="d", big.mark=",")`)
  + Total people with one dose vaccination: **`r (dataWidePlain$Total.people.vaccine.onedose) %>% formatC(format="d", big.mark=",")`** (`r (ifelse(is.null(dataWidePlain$New.people.vaccine.onedose), sprintf("NA"), sprintf("up")))` `r ((dataWidePlain$New.people.vaccine.onedose)) %>% formatC(format="d", big.mark=",")`)
